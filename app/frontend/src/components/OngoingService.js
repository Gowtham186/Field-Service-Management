...
export default function OngoingService() {
    ...
    return (
        <div  className="bg-gray-50 p-6 rounded-lg shadow-md mb-4">
            <h2 className="text-lg font-semibold mb-3">Today service</h2>

            {ongoingService ? (
                <div>
                    <h3 className="text-lg font-semibold">{ongoingService.serviceType[0]?.servicesChoosen[0]?.serviceName}</h3>
